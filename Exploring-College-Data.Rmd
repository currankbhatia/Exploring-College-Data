...
salaries$`Mid-Career Median Salary` = defactorize(salaries$`Mid-Career Median Salary`)
...
ggplot(midcareer_type_df, aes(types_colleges, avg_midcareer, fill = types_colleges)) + geom_col()
